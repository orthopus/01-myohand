#ifndef _ROS_myohand_ros_logger_msg_def_h
#define _ROS_myohand_ros_logger_msg_def_h
...
namespace myohand_ros_logger
{
  ...
  class msg_def : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "myohand_ros_logger/msg_def"; };
    virtual const char * getMD5() override { return "8a60facf2b9d21412b18d2030b3eeac4"; };
